...
<body>
   ...
   <div class="head"><marquee>Mentor on Demand</marquee></div>
    <div class="bord"><br>
     ...
     <br>  <h1 style="text-align:center">Mentor List</h1><br><br>
<%
...
<div class="container">
       ...
       %>
           ...
           <tr> <td><p class="col-md-2 ptext"><%=e.getMentorId() %></p></td>
                           ...
                           <a href="update?companyCode=<%= e.getMentorId() %>"><input type="submit" value="update"></a></p></td>
                           <td><p class="col-md-2 ptext">
                           <a href="delete?companyCode=<%= e.getMentorId() %>"><input type="submit" value="delete"></a></p></td>
                           </tr>
                           <% }%>
                           </table>
                     </section> 
