...
<div class="container">
       ...
       %>
           ...
           <tr> <td><p class="col-md-2 ptext"><%=e.getId() %></p></td>
                          ...
                          <a href="confirmStatus?id=<%=mentor.getMentorId()%>&userId=<%=e.getId()%>"><input
                                  type="submit" value="<%=e.getStatusUser() %>" class="btn btn-dark"></a>
</td> <td><p class="col-md-2 ptext"><input type="submit" value="reject"></p></td>
                           </tr>
                           <% }%>
                           </table>
                     </section> 
