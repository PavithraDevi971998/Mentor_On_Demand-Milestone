	...
	<div class="bord">
		...
		<div class="topnav">
			<a href="/searchMentor">Search Training</a> <a
				href="/searchMentorTime">Current Training</a> <a
				href="/adminmentorList">Completed Training</a> <a href="/mentorList">Search</a>
       ...
       %>
				...
				<tr>
					...
					<td><p class="col-md-2 ptext">
							<a
								href="updateStatus?id=<%= e.getMentorId() %>&userId=<%=user.getId()%>"><input
								type="submit" value="<%=e.getStatusMentor()%>"></a></td>
