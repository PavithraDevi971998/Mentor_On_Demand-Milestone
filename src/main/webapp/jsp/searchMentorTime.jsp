...
<body>
	...
	<p style="text-align: center; font-size: 32px;">Mentor</p>
	<br>
	<div class="bord">
	...
	<form:form method="POST" action="/searchMentorTime" modelAttribute="c2"><br><br>
			<table id="#table1 ">
		
			<tr>
				<th>Time:</th>
				<td style="padding-left:50px"><form:input path="fromTime" type="text" />
				<br>
				<form:errors path="fromTime" class="text-danger" /></td></tr>
